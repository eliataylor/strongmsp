...
ALLOWED_HOSTS = [get_tld(API_HOST_PARTS.hostname), f".{get_tld(API_HOST_PARTS.hostname)}", "strongmsp-api-cloudrun-239638481880.us-west1.run.app", ".strongmsp-api-cloudrun-239638481880.us-west1.run.app"]
...
CORS_ALLOWED_ORIGINS += [f"{APP_HOST_PARTS.scheme}://localhost:{DEV_PORT}",
                         ...
                         "https://strongmsp-api-cloudrun-239638481880.us-west1.run.app",
                         f"{APP_HOST_PARTS.scheme}://localhost.strongmindstrongperformance.com:{DEV_PORT}",
