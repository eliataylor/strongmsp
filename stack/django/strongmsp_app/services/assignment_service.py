...
class AssignmentService:
    ...
    def get_all(self):
        ...
        if self._assignments is None:
            ...
            for assignment in assignments:
                roles = self._get_user_roles_in_assignment(assignment)
    ...
    def get_by_role(self, role):
        ...
        filtered = [a for a in all_assignments if role in a['roles']]
    ...
    def get_user_role_in_assignment(self, assignment):
        """
        Determines user's role(s) in the given assignment.
        Returns list of role strings.
        """
        return self._get_user_roles_in_assignment(assignment)
    ...
    def _get_user_roles_in_assignment(self, assignment):
        """
        Internal method to determine user's roles in an assignment.
